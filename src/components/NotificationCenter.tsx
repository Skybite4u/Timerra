...
export const NotificationCenter: React.FC<NotificationCenterProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-md animate-fade-in select-none">
      ...
      <div className="relative w-full max-w-lg h-full bg-[#070b1a]/95 border-l border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden animate-slide-in">
